function ppe_cDE(maxx,minx,dim,fun_num,f,cr)
...
xlswrite('10ppe_cDEavg+std.xlsx',avg_bestvalue(max_generation),1, strcat('A',num2str(fun_num)));
xlswrite('10ppe_cDEavg+std.xlsx',StandardDeviation',1,strcat('B',num2str(fun_num)));
xlswrite('10ppe_cDEbestsolution.xlsx',bestsolution, num2str(fun_num));
xlswrite('10ppe_cDEbestvalue.xlsx',bestvalue(:,max_generation)', num2str(fun_num));
