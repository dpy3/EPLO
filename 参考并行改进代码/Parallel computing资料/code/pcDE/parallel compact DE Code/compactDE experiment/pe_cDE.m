function pe_cDE(maxx,minx,dim,fun_num,f,cr)
...
xlswrite('10avg+std.xlsx',avg_bestvalue(max_generation),1, strcat('A',num2str(fun_num)));
xlswrite('10avg+std.xlsx',StandardDeviation',1,strcat('B',num2str(fun_num)));
% xlswrite('avg_bestvalue.xlsx',avg_bestvalue, num2str(fun_num));
xlswrite('10bestsolution.xlsx',bestsolution, num2str(fun_num));
xlswrite('10bestvalue.xlsx',bestvalue(:,max_generation)', num2str(fun_num));
