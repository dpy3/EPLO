...
function [fMin , bestX,Convergence_curve ] = CSSA(fhd,dim,pop,M,c,d,varargin)
...
if(r2<0.8)
 ...
 [ fMMin, bestII ] = min( fit );      
  ...
  % fit =feval(fhd,x',varargin{:});
    ...
    munew = mu;
    mu = updateMuPV(winner,loser,munew,Np,d);
    sicma = updateSicmaPV(winner,loser,munew,sicma,Np,d); 
