...
% Multi-path Multi-UAV planning, path conflict detection, dynamic obstacle avoidance (integrated EPLO)
clear; clc; close all;
...
%% 7. Takeoff scheduling optimization using EPLO strategy
fprintf('Optimizing takeoff schedule (EPLO)...\n');
% Initialize delays
...
% Run EPLO (record convergence curve)
[bestDelays, bestFitness, convCurve] = EPLO(popSize, maxIter, lb, ub, dim, fitnessFunc);
...
title(ax2, 'EPLO Convergence Curve', 'FontSize', 16);
...
%% --- EPLO function (parallel subpopulations) ---
